...
def save_results(n_gpu_layers, tokens_per_second):
    results = {
...
def parse_output(output):
    ...
    return offloaded_layers, total_layers, tokens_per_second
...
if __name__ == "__main__":
    ...
    while n_gpu_layers >= 0:
        ...
        offloaded_layers, total_layers, tokens_per_second = parse_output(result.stderr)
        ...
        save_results(n_gpu_layers, tokens_per_second)
        n_gpu_layers -= 1
